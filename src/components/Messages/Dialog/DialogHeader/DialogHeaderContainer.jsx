...
const mapStateToProps = (state) => ({
    ...
    //refactoring: example lastMessages: state.messagesPage.messagesData.map(lastM => <LastMessage key={lastM.id} name={lastM.name} img={lastM.img} date={lastM.date} message={lastM.message} />)
});
