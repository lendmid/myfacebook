...
import LastMessage from './LastMessages/LastMessage/LastMessage';
...
const Messages = (props) => {
    let lastMessages = props.messagesPage.messagesData.map(lastM => <LastMessageItem id={lastM.id} name={lastM.name}
