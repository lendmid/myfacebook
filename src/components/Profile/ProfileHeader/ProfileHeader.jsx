...
const ProfileHeader = React.memo(({profile, status, updateStatus, isOwner, updatingPhoto, setUpdatingPhoto, savePhoto}) => {
    return (
        <div className={s.profile_header}>
            {updatingPhoto && <UpdateUserPhoto setUpdatingPhoto={setUpdatingPhoto} savePhoto={savePhoto} />}
