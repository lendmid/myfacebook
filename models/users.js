...
// на каждый необходимый нам метод у нас будет функция в модели, которая будет работать с бд. Функции в контроллере ничего не знает о базе данных и просто выполняет методы из модели4 когда получаем данные выводим их на экран
